...
namespace TheScoreBook.views.shoot
{
    public partial class RoundSelectionPage : AnimationPage
    {
        ...
        public Style[] PossibleStyles => EnumClass.GetAll<Style>().ToArray();
        ...
        {
            var round = Services.Create<Round>(SelectedRound.ToLower(), PossibleStyles[SelectedStyle], SelectedDate);
